...
class PerkResurrection : public ResurrectionAPI {
    bool should_resurrect(RE::Actor* a) const override {
        static auto perk =
            RE::TESDataHandler::GetSingleton()->LookupForm<RE::BGSPerk>(EscapeFromDeath_Perk, plugin_name);
        static auto mgef =
            RE::TESDataHandler::GetSingleton()->LookupForm<RE::EffectSetting>(EscapeFromDeath_Mgef, plugin_name);
    ...
    void resurrect(RE::Actor* a) override {
        ...
        static auto spel =
            RE::TESDataHandler::GetSingleton()->LookupForm<RE::SpellItem>(EscapeFromDeath_Spel, plugin_name);
        cast_spell(a, a, spel);
        static auto mesg =
            RE::TESDataHandler::GetSingleton()->LookupForm<RE::BGSMessage>(EscapeFromDeath_Mesg, plugin_name);
...
SKSEPluginLoad(const SKSE::LoadInterface *skse) {
    ...
    auto g_messaging =
        reinterpret_cast<SKSE::MessagingInterface*>(skse->QueryInterface(SKSE::LoadInterface::kMessaging));
    if (!g_messaging) {
